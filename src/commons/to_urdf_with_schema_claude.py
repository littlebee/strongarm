...
def create_urdf_from_config(config: Dict[str, Any]) -> ET.Element:
...
def save_urdf(config: Dict[str, Any], filename: str):
    robot = create_urdf_from_config(config)
...
if __name__ == "__main__":
    ...
    # Generate URDF file
    save_urdf(mock_arm_config, "strongarm.urdf")
